...
//---------------------------------------------------------------------
        double tm;
        if(serial) tm=sssor_ULL(tc, httpData);
        else tm=ssor_ULL(tc, httpData);
...
//---------------------------------------------------------------------
    ...
    public double sssor_ULL(TimeController tc, HTTPData httpData){
        int i, j, k, m, n;
        int istep;
        double  tmp;
        double  delunm[] = new double[5], tv[] = new double[5*(isiz1/2*2+1)*isiz2];
...
//---------------------------------------------------------------------
    ...
    public double ssor_ULL(TimeController tc, HTTPData httpData){
        int i, j, k, m, n;
        int istep;
        double  delunm[] = new double[5], tv[] = new double[5*(isiz1/2*2+1)*isiz2];
        double tmp = 1.0 / ( omega * ( 2.0 - omega ) );
